...
?>
    ...
    <body>
        ...
        <div class="card">
            ...
            <table width=" 1000px">
                <tr>
                    <th style="background-color: #F9C560;" class="text-center" colspan="4">Danh sách nhà hàng</th>
                </tr>
                <?php
                $sql = "SELECT * FROM restaurants ORDER BY rs_id DESC";
                ...
                if (mysqli_num_rows($query) > 0) {
                    ...
                    while ($row = mysqli_fetch_array($query)) {
                        ...
                        echo '<td style="width: 85%;">' . $row['res_name'] . '</td>';
                        echo '<td style="width: 5%;"<td><a href="update_restaurant.php?res_upd='. $row['rs_id'] .'" ><i class="fa fa-pencil" style="font-size:16px; color: #1976D2;"></i></a></td>';
                        echo '<td style="width: 5%;"<td><a href="delete_restaurant.php?res_del=' . $row['rs_id'] . '" ><i class="fa fa-trash-o" style="font-size:16px; color: #D42216;"></i></a></td>';
                        echo '</tr>';
                        $count++;
                    }
                } else {
                    echo '<tr><td colspan="4"><center>Chưa có nhà hàng nào</center></td></tr>';
                }
                ?>
            </table>
