...
?>
    ...
    <body>
        ...
        <div class="card">
            <table width="1000px">
                <tr>
                    <th style="background-color: #F9C560;" class="text-center" colspan="4">Danh sách thành viên</th>
                </tr>
                <?php
                ...
                if (mysqli_num_rows($query) > 0) {
                    ...
                    while ($row = mysqli_fetch_array($query)) {
                        ...
                        echo '<td style="width: 85%;">' . $row['username'] . '</td>';
                        echo '<td style="width: 5%;"<td><a href="update_users.php?user_upd=' . $row['u_id'] . '" ><i class="fa fa-pencil" style="font-size:16px; color: #1976D2;"></i></a></td>';
                        echo '<td style="width: 5%;"<td><a href="delete_users.php?user_del=' . $row['u_id'] . '" ><i class="fa fa-trash-o" style="font-size:16px; color: #D42216;"></i></a></td>';
                        echo '</tr>';
                        $count++;
                    }
                } else {
                    echo '<tr><td colspan="4"><center>Chưa có thành viên nào</center></td></tr>';
                }
                ?>
            </table>
