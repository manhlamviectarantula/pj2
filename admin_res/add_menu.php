...
if (isset($_POST['submit'])) {
    ...
    $mql2 = "INSERT INTO dishes (rs_id,d_name,d_des,price,image) 
    VALUES ('$rs_id','$d_name','$d_des','$price','$image')";

    header("Location: add_menu.php?registed=Thêm món ăn thành công");
...
<body>
    ...
    <div class="card card-form">
        <div class="wrapper-btn">
            <a href="add_menu.php" class="card-btn current">Thêm món ăn</a>
        </div>
            ...
            <form class="fill-form" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <input type="text" id="" name="d_name" required="" oninvalid="this.setCustomValidity('Chưa nhập Tên món ăn')" oninput="setCustomValidity('')">
                    </div>
                    <div class="col-6">
                        <label for="email">Mô tả</label>
                        <input type="text" id="" name="d_des" required="" oninvalid="this.setCustomValidity('Chưa nhập Mô tả')" oninput="setCustomValidity('')">
                    </div>
                    <div class="col-6">
                        <label for="phone">Giá</label>
                        <input type="text" id="" name="price" oninput="formatCurrency(this)">
                    </div>
                    <div class="col-6">
